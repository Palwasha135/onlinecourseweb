...
const Section3 = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-start w-full mb-20">
      <h1 className=" text-base font-medium title-font mb-4 text-[#ff3300ee]">what we do ____</h1>
    ...
    <div className="flex flex-wrap -m-4 text-center p-8">
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full hover:underline hover:underline-offset-8 decoration-4">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg text-center "style={{ boxShadow: "10px 10px red" }}>
          ...
          <h2 className="title-font font-medium text-3xl text-white mt-5">Signup</h2>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full hover:underline hover:underline-offset-8 decoration-4">
        ...
        <Image src="/images/course.png" alt="course" width={100} height={100} className="mx-auto"/>
          <h2 className="title-font font-medium text-3xl text-white mt-5">Select Course</h2>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full hover:underline hover:underline-offset-8 decoration-4">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg text-center "style={{ boxShadow: "10px 10px red" }}>
          ...
          <h2 className="title-font font-medium text-3xl text-white mt-5">Start Learning</h2>
      ...
      <div className="p-4 md:w-1/4 sm:w-1/2 w-full hover:underline hover:underline-offset-8 decoration-4">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg text-center" style={{ boxShadow: "10px 10px red" }}>
          ...
          <h2 className="title-font font-medium text-3xl text-white mt-5">Get certificate</h2>
